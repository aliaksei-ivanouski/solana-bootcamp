...
export type CloseInput<
  ...
  TAccountBootcampdapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountBootcampdapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountBootcampdapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.bootcampdapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountBootcampdapp>;
